...
export default function App() {
  ...
  async function startRecording() {
    if (busy) return;
    resetClip(); setSeconds(0); setPhase('requesting');
  ...
  return <div className="app-shell">
    <header className="topbar"><a className="brand" href="#" onClick={event => { event.preventDefault(); setTab('lab'); }}><span className="brand-mark"><AudioLines size={25} /></span><span>小小声音<span className="brand-light">实验室</span><small>LITTLE VOICE LAB</small></span></a><span className="version-pill">家庭测试版 <span>0.1</span></span></header>
    <main>
      ...
      {tab === 'lab' ? <div className="lab-grid"><div className="main-column">
        ...
        <div className="field-note"><span className="note-star">✳</span><div><h3>这是实验，不是考试</h3><p>音素匹配不是发音评分。儿童声音、口音和环境都可能影响模型，家长的观察同样重要。</p></div></div>
